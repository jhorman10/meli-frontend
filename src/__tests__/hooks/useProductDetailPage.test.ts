...
describe('useProductDetailPage', () => {
  ...
  it('should return initial loading state', () => {
    ...
    const { result } = renderHook(() => useProductDetailPage('MLA123'));
  ...
  it('should set thumbnail as selectedImage when no pictures', async () => {
    ...
    mockProductService.getProductById.mockResolvedValue(productWithoutPictures);
